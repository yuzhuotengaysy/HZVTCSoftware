        ...
        <div class="container mainsection">
            <div class="row">
                <div class="col-sm-8 col-sm-push-4">
                    <h3>第七届东忠杯程序设计大赛结果</h3>
                    <div class="noticeDate">
                        <span class="glyphicon glyphicon-calendar" aria-hidden="true"><span>发布时间:2016-05-19</span></span>
                    </div>
                    <div class="noticeContent">
                        <p>
                            第七届东忠杯程序设计大赛落下帷幕,以下是结果.
                        </p>
                        <img src="../images/notice/02-1.png" alt="">
                    </div>
                </div>
