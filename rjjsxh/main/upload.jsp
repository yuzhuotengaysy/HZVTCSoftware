<%@ page contentType="text/html; charset=utf-8" import="java.util.*,java.io.*,java.text.*,com.jspsmart.upload.*,java.sql.*"%>
...
<%
	...
	try{
		...
		String sql = "update customer set cuspic=? where cusname = ?";
